...
const hospital = createSlice({
  ...
  extraReducers:(builder) =>{
    builder.addCase(fetchHospitalTypes.fulfilled,(state,action: PayloadAction<Array<String>>)=>{
    ...
    builder.addCase(updateHospitalDetails.fulfilled,(state,action:PayloadAction<HospitalRequest>)=>{
    ...
    builder.addCase(fetchHospitalNames.fulfilled,(state,action:PayloadAction<Array<String>>)=>{
...
export const fetchHospitalTypes = createAsyncThunk("hospital/fetchHospitalTypes", async() =>{
    const response = await hospitalService.fetchHospitalTypes();
    return response;
})

  
export const fetchHospitalNames = createAsyncThunk("hospital/fetchHospitalNames", async() =>{
  const response = await hospitalService.fetchHospitalNames();
  return response;
})

  
export const updateHospitalDetails = createAsyncThunk("hospital/updateHospitalDetails", async(hospitalData:Hospital) =>{
