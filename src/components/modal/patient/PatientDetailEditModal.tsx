import { Box, Button, FormControlLabel, Grid, InputLabel, MenuItem, Modal, Radio, RadioGroup, Select, Stack, TextField, TextareaAutosize, Typography } from "@mui/material";
        ...
        >
          ...
          <FormControlLabel value="female" control={<Radio />} label="Kadın" />
              ...
              <TextareaAutosize
                    aria-label="Adres"
                    placeholder="Adres"
                    value={patient.address as string}
                    minRows={3}
                    style={{ width: "100%" }}
