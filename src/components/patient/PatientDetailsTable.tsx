...
export const PatientDetailsTable: React.FC = () => {
    ...
    const [isPatientEditModalOpen, setIsPatientEditModalOpen] = useState<boolean>(false);
  ...
  <TableBody>
      {rows.map((row) => (
          <TableRow key={row.id}>
              ...
              <TableCell><Button variant="outlined" color="success" onClick={handleOpenPatientDetailEditModal}>Değiştir</Button></TableCell>
          </TableRow>
      ))}
  </TableBody>
</Table>
